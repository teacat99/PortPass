export default {
  ...
  settings: {
    ...
    presetCategory: '分类',
    presetCategoryAuto: '自动识别',
    presetCategoryAutoHint: '按预设名称与端口自动归类',
    presetCategoryNew: '新增分类',
    presetCategoryEdit: '编辑分类',
    presetCategoryDelete: '删除分类',
    presetCategoryDeleteConfirm: '删除分类「{name}」？该分类下的预设将回退为自动识别。',
    presetCategoryLabel: '分类名称',
    presetCategoryLabelPlaceholder: '例如 监控 / 自定义服务',
    presetCategoryIcon: '图标',
    presetCategoryBuiltinHint: '内置分类，仅支持改名与改图标',
    presetCategoryUserHint: '自定义分类',
    presetCategoryEmptyName: '请填写分类名称',
    presetCategorySaved: '分类已保存',
    presetCategoryDeleted: '分类已删除',
    iconNoneHint: '尚未选择图标',
    iconTabEmoji: '常用图标',
    iconTabUrl: '图片 URL',
    iconUrlHint: '可粘贴 favicon.im、t1.gstatic.com/faviconV2 等返回站点图标的链接，会自动以圆角显示',
    tabSecurity: '登录历史',
